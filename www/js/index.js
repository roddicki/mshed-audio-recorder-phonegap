...
document.addEventListener('deviceready', function() {
    ...
    document.getElementById('map-popover-dismiss').addEventListener('click', function() {
        console.log('map-popover-dismiss');
        window.plugins.toast.show('Please double tap to add a location to the map', '4000', 'center');
    });
